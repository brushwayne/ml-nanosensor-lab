...
def submit():
    ...
    # print(s11_file, gain_file, save_file, gain_split, s11_split)
...
s11_label = ttk.Label(root, text = 'S11 Filename', anchor="e", font=(Font, FontSize, 'bold'))
s11_entry = ttk.Entry(root,textvariable = s11_file_var, font=(Font, FontSize,'normal'))

gain_label = ttk.Label(root, text = 'Gain Filename', anchor="e", font=(Font, FontSize, 'bold'))
gain_entry = ttk.Entry(root,textvariable = gain_file_var,font=(Font, FontSize,'normal'))

savefile_label = ttk.Label(root, text = 'Save Filename', anchor="e", font=(Font, FontSize, 'bold'))
savefile_entry = ttk.Entry(root,textvariable = save_file_var,font=(Font, FontSize,'normal'))

gain_split_label = ttk.Label(root, text = 'Gain Split Number', anchor="e", font=(Font, FontSize, 'bold'))
gain_split_entry = ttk.Entry(root,textvariable = gain_split_var, font=(Font, FontSize,'normal'))

s11_split_label = ttk.Label(root, text = 'S11 Split Number', anchor="e", font=(Font, FontSize, 'bold'))
